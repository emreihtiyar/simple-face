...
class Facenet512(BaseVectorizer):
    TARGET_SIZE = (160, 160)
    WEIGHTS_NAME = "facenet512_weights.h5"
    ...
    RECOMENDED_THRESHOLDS = {"cosine": 0.30, "euclidean": 23.56, "euclidean_l2": 1.04}
    def __init__(self, *args, **kwargs):
        super().__init__()
        self.build()
    def build(self):
        self._check_weight()
        self._model = inception_resnet.InceptionResNetV2(dimension=512)
